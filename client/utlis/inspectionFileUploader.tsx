...
const InspectionFileUploader: React.FC<fileType> = ({ handleReturn }) => {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/inspection/upload`,
        {
          method: "POST",
          body: formData,
        }
...
export default InspectionFileUploader;
